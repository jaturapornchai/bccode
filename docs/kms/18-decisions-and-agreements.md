...
| 2026-09-08 | **เพิ่มเมนู 15 รายการให้เทียบเท่า FlowAccount + PEAK (185 → 200 เมนู)** และ **ไม่ทำระบบเงินเดือน** (ตัด payroll, ภ.ง.ด.1, ไฟล์ประกันสังคม ออกจากขอบเขต — ห้ามเพิ่มกลับเอง) | เพิ่มเฉพาะรายการเมนู ยังไม่สร้างจอ/กฎธุรกิจ; รายการที่กฎยังไม่ชัด (XBRL ไฟล์ธนาคาร ระดับอนุมัติ เทมเพลตนำเข้าเอกสาร) เปิดเมนูไว้ก่อนและรอลุงจืดกำหนดกฎ (ADR decisions/2026-09-08-menu-parity-flowaccount-peak.md, รายละเอียด 19-menu-coverage-flowaccount-peak.md) |
...
6. taxonomy XBRL ของ DBD, รูปแบบไฟล์โอนเงินธนาคาร, ระดับการอนุมัติรายจ่าย, เทมเพลตนำเข้าเอกสาร — เมนูเปิดไว้แล้ว 2026-09-08 แต่ยังไม่มีกฎ (เงินเดือน/ภ.ง.ด.1/ประกันสังคม ตัดออกจากขอบเขตแล้ว ไม่ต้องถาม)
