...
- **ผ่านรายการค่าเสื่อมราคารายงวด**:
  - `Dr. ค่าใช้จ่ายค่าเสื่อมราคา` / `Cr. ค่าเสื่อมราคาสะสม` — รหัสบัญชีมาจากสินทรัพย์ → ประเภทสินทรัพย์ ถ้าไม่มีทั้งคู่ระบบถามผู้ใช้ ไม่เดารหัส (แก้ 2026-09-24: [bugs/2026-09-24-fixed-asset-gl-guessed-accounts.md](../bugs/2026-09-24-fixed-asset-gl-guessed-accounts.md))
  - เลขใบสำคัญขึ้นต้นด้วยรหัสสมุดรายวันประเภททั่วไปที่เปิดใช้งาน และหัวเอกสารผ่านการตรวจสาขาแบบเดียวกับหน้าบันทึกรายวัน
...
- **การจำหน่ายสินทรัพย์ (Asset Disposal)**:
  ...
  - `Cr. ภาษีขาย (ถ้ามี — บัญชีภาษีขาย บัญชีรับชำระ และบัญชีกำไร/ขาดทุน ผู้ใช้ระบุในหน้าต่างจำหน่าย)`
