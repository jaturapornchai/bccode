...
2. กด **เพิ่ม MCP token** หรือ **เพิ่ม API token** เพื่อเปิดฟอร์มที่เลือกประเภทไว้แล้ว ระบุชื่อ แล้วเลือก `readonly` (ค่าเริ่มต้น) หรือ `readwrite` เลือกบริษัทที่อนุญาตได้ 1–100 บริษัท (เฉพาะบริษัทที่ผู้สร้างเข้าได้ทั้งบริษัท — ADMIN ที่จำกัดบริษัทเห็นและเลือกได้แค่บริษัทของตัวเอง) และอายุ 1–365 วัน (ค่าเริ่มต้น 90 วัน) หน้าจอแยกรายการ/รายละเอียดที่ปรับความกว้างได้ และพับคำแนะนำเชื่อมต่อไว้ใต้ฟอร์ม
...
5. เรียก initialize, tools/list และ tools/call; แต่ละ request ตรวจวันหมดอายุ การเพิกถอน สมาชิก/บทบาทผู้สร้าง บริษัทและสาขาที่ยัง active จาก PostgreSQL ใหม่ และตัดบริษัทที่อยู่นอกขอบเขตปัจจุบันของผู้สร้างทิ้ง (ADR [2026-09-24-holding-wide-access-scope](../decisions/2026-09-24-holding-wide-access-scope.md))
