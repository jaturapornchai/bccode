...
หลักฐาน runtime local (อ่านอย่างเดียว 2026-09-07): `outboxevents` productprojection = PUBLISHED 7 / PENDING 0; Mongo `demo` active products 45 = PG `demo.product` 45 ✓; Mongo `demo` active productbarcodes **45 ≠ PG `demo.productbarcode` 54** (ยังไม่วินิจฉัย — docs/handoff/HANDOFF-2026-09-06.md:60 ระบุแถวค้าง 9 แถวใน C03); `product_projection_fences` 2 แถว; PG `bc001` product 20/productbarcode 20, `test` 49/45
