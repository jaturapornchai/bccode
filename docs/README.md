...
| **สถานะงานค้าง / สรุปความเสี่ยงระบบ** | [`docs/handoff/HANDOFF-2026-09-14.md`](handoff/HANDOFF-2026-09-14.md) (ล่าสุด — prompt ให้ Gemini แก้ต่อจาก code review; อ่านไฟล์นี้ก่อนเสมอ; รอบก่อน [`HANDOFF-2026-09-09.md`](handoff/HANDOFF-2026-09-09.md), [`HANDOFF-2026-09-08.md`](handoff/HANDOFF-2026-09-08.md) เรื่องเมนู) → ต้องการสถานะ repo/วิธีรัน/งานค้าง backend อ่านต่อที่ [`HANDOFF-2026-09-06.md`](handoff/HANDOFF-2026-09-06.md) · ความเสี่ยง outbox/projection ที่ [`HANDOFF-RISKS-2026-09-05.md`](handoff/HANDOFF-RISKS-2026-09-05.md) | อ่านเฉพาะเมื่อลุงจืดสั่ง/ถามความเสี่ยง |
