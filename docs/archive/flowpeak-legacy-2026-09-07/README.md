...
> **⚠️ เอกสารเก็บถาวร (ARCHIVED 2026-09-07) — ไม่ใช่ขอบเขตหรือข้อกำหนดปัจจุบัน** ย้ายมาเก็บเป็นประวัติเมื่อ 2026-09-07 (ดู [`ARCHIVE-NOTE.md`](ARCHIVE-NOTE.md)) ห้ามใช้อ้างอิงสเปก/schema/เมนู — ของปัจจุบันอยู่ที่ [`docs/features-flowaccount-peak/README.md`](../../features-flowaccount-peak/README.md) (หลักฐานฝั่งคู่แข่ง) และ [`docs/kms/19-menu-coverage-flowaccount-peak.md`](../../kms/19-menu-coverage-flowaccount-peak.md) (เมนู BC 224 รายการ) · เลข "18 หมวด 243 รายการ" ในบรรทัดถัดไปเป็นของรอบเก่า ไม่ใช่ขอบเขตปัจจุบัน
