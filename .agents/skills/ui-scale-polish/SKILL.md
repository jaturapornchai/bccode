...
- **แบบแผน**: ถ้างานหนึ่งมีจอเจ้าของอยู่แล้ว (เช่น เพิ่ม/ถอดผู้ดูแลกลุ่มกิจการ → การตั้งค่าระบบ › ผู้ใช้งานระบบ, `PUT/DELETE /holding/permission`) จออื่นแสดง **รายการอ่านอย่างเดียว** + ข้อความไทยบอกทางไปจอเจ้าของงาน (key ใน `languages.tsv`) — ไม่ทำฟอร์มซ้ำอีกชุด; ป้ายปุ่มเปิดต้องตรงกับสิ่งที่ทำได้จริง ("ดูรายชื่อผู้ดูแล" ไม่ใช่ "จัดการผู้ดูแล")
