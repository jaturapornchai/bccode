...
- **Tenant Scope**: Include `tenantid` or the project-standard tenant key `holdingcode`; new PostgreSQL table/column/index names must be lowercase with no underscore.
