...
- **Company Scope**: `businesscode` is the user-facing company code and must be normalized to uppercase before validation, duplicate checks, search, save, and sync.
