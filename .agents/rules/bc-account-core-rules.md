...
- **Radio Buttons vs Combo Box (Select)**: หากฟิลด์ข้อมูลมีตัวเลือกคงที่จำนวนน้อย (ไม่เกิน 4 ตัวเลือก) ให้เลือกใช้ Radio buttons (`RadioOptionGroup` / ปุ่มตัวเลือกวิทยุ) แทน Dropdown (`CustomSelect` / Combo Box) เสมอ เพื่อให้ผู้ใช้เห็นตัวเลือกทั้งหมดได้ทันทีและลดจำนวนการคลิก เช่น ประเภทสินค้า ประเภทวัตถุดิบ ประเภทภาษี หรือตัวเลือกเปิด/ปิดการคิดคะแนนสะสม โดยหากเป็น Radio buttons หรือ Checkbox ให้พยายามใช้รูปแบบจัดกลุ่มแนวนอนและห่อคำ/จัดแถวใหม่ (flex-wrap) เพื่อประหยัดความสูงของหน้าจอ (vertical space) และหลีกเลี่ยงการจัดเรียงแนวตั้งแบบ 1 บรรทัดต่อ 1 ตัวเลือกเดี่ยว
