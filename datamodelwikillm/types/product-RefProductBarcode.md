...
โครงสร้าง `RefProductBarcode` จากโมดูล mainapi `product` มีฟิลด์ตามซอร์ส `product.go`
...
| MarketplaceSKUMappings | *[][[product-MarketplaceSKUMap\|MarketplaceSKUMap]] | marketplaceskumappings | marketplaceskumappings | ค่าของ MarketplaceSKUMappings ตามฟิลด์ `marketplaceskumappings` ในซอร์ส |

## ความสัมพันธ์

- Struct ที่ฝังหรืออ้างอิง: [[NameX]], [[product-MarketplaceSKUMap|MarketplaceSKUMap]]
