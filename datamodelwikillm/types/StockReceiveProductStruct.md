...
# StockReceiveProductStruct

เอกสารรับสินค้าเข้าคลัง (stock receive product document, TransFlag 60 ตาม comment ในซอร์ส) เก็บ header พร้อมข้อมูลการชำระเงินและรายการรายละเอียด
...
| Details | [][[StockReceiveProductDetailStruct]] | details | details | รายการรายละเอียดการรับสินค้า |
...
## ความสัมพันธ์
- ฝัง [[MongoBranchModel]] (Branch), [[StockReceiveProductDetailStruct]] (Details)
