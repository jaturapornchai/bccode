...
# StockReceiveProductDetailStruct

รายการรายละเอียด (detail line) ของเอกสารรับสินค้า [[StockReceiveProductStruct]] ระบุสินค้า จำนวน ราคา และคลัง/ที่เก็บ
...
- ถูกฝังเป็น `Details` ใน [[StockReceiveProductStruct]]
