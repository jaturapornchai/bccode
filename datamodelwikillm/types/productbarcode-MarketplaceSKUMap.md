...
โครงสร้าง `MarketplaceSKUMap` จากโมดูล mainapi `productbarcode` มีฟิลด์ตามซอร์ส `product_barcode.go`
...
| MarketplaceDimensionStocks | *[][[productbarcode-MarketplaceDimensionStock\|MarketplaceDimensionStock]] | marketplacedimensionstocks | marketplacedimensionstocks | ค่าของ MarketplaceDimensionStocks ตามฟิลด์ `marketplacedimensionstocks` ในซอร์ส |
...
- Struct ที่ฝังหรืออ้างอิง: [[productbarcode-MarketplaceMediaAsset|MarketplaceMediaAsset]], [[productbarcode-MarketplaceAttribute|MarketplaceAttribute]], [[productbarcode-MarketplaceDimensionStock|MarketplaceDimensionStock]]
