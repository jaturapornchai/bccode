...
# ProductBarcodeBOMViewActivity

โครงสร้าง `ProductBarcodeBOMViewActivity` จากโมดูล mainapi `bom` มีฟิลด์ตามซอร์ส `bom.go`
...
- Struct ที่ฝังหรืออ้างอิง: [[bom-ProductBarcodeBOMViewData|ProductBarcodeBOMViewData]], [[ActivityTime]]
