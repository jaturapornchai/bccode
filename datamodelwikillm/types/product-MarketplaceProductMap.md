...
โครงสร้าง `MarketplaceProductMap` จากโมดูล mainapi `product` มีฟิลด์ตามซอร์ส `product.go`
...
| SpecificationGroups | *[][[product-MarketplaceSpecificationGroup\|MarketplaceSpecificationGroup]] | specificationgroups | specificationgroups | ค่าของ SpecificationGroups ตามฟิลด์ `specificationgroups` ในซอร์ส |
...
| PayloadExamples | *[][[product-MarketplacePayloadExample\|MarketplacePayloadExample]] | payloadexamples | payloadexamples | ค่าของ PayloadExamples ตามฟิลด์ `payloadexamples` ในซอร์ส |
...
- Struct ที่ฝังหรืออ้างอิง: [[product-MarketplaceMediaAsset|MarketplaceMediaAsset]], [[product-MarketplaceSpecificationGroup|MarketplaceSpecificationGroup]], [[product-MarketplaceAttribute|MarketplaceAttribute]], [[product-MarketplacePayloadExample|MarketplacePayloadExample]]
