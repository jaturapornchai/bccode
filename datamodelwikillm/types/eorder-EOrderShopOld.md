...
โครงสร้าง `EOrderShopOld` จากโมดูล mainapi `eorder` มีฟิลด์ตามซอร์ส `eorder_shop.go`
...
| IsBcMember | bool | - | isbcmember | ค่าของ IsBcMember ตามฟิลด์ `isbcmember` ในซอร์ส |
| ApiKey | string | - | apikey | ค่าของ ApiKey ตามฟิลด์ `apikey` ในซอร์ส |
| OrderStation | [[eorder-EOrderShopOrderOld\|EOrderShopOrderOld]] | - | orderstation,omitempty | ค่าของ OrderStation ตามฟิลด์ `orderstation` ในซอร์ส |
| Kitchens | [][[Kitchen\|kitchen_models.Kitchen]] | kitchens | kitchens | ค่าของ Kitchens ตามฟิลด์ `kitchens` ในซอร์ส |

## ความสัมพันธ์

- Struct ที่ฝังหรืออ้างอิง: [[eorder-EOrderShopOrderOld|EOrderShopOrderOld]], [[Kitchen]]
