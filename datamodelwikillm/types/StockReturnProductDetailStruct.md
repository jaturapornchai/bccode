...
# StockReturnProductDetailStruct

รายการรายละเอียด (detail line) ของเอกสารคืนสินค้า [[StockReturnProductStruct]] ระบุสินค้า จำนวน ราคา และคลัง/ที่เก็บ
...
- ถูกฝังเป็น `Details` ใน [[StockReturnProductStruct]]
