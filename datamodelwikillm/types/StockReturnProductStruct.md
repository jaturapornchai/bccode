...
เอกสารคืนสินค้าเข้าคลัง (stock return product document, TransFlag 58 ตาม comment ในซอร์ส) เก็บ header พร้อมข้อมูลการชำระเงินและรายการรายละเอียด
...
| Details | [][[StockReturnProductDetailStruct]] | details | details | รายการรายละเอียดการคืนสินค้า |
...
## ความสัมพันธ์
- ฝัง [[MongoBranchModel]] (Branch), [[StockReturnProductDetailStruct]] (Details)
