...
-- 10. Chart of Accounts (ผังบัญชีมาตรฐานวิชาชีพบัญชีไทย)
INSERT INTO gl_records (company, kind, id, code, version, payload)
VALUES
  -- หมวด 1 สินทรัพย์
  ('01', 'accounts', 'acc-11000', '11000', 1, '{"accountcode": "11000", "name": "เงินสด", "names": [{"code": "th", "name": "เงินสด"}], "accounttype": "asset", "normalbalance": "debit", "allowposting": true, "iscash": true, "isactive": true}'),
  ('01', 'accounts', 'acc-11100', '11100', 1, '{"accountcode": "11100", "name": "เงินฝากกระแสรายวัน", "names": [{"code": "th", "name": "เงินฝากกระแสรายวัน"}], "accounttype": "asset", "normalbalance": "debit", "allowposting": true, "iscash": true, "isactive": true}'),
  ('01', 'accounts', 'acc-11200', '11200', 1, '{"accountcode": "11200", "name": "เงินฝากออมทรัพย์", "names": [{"code": "th", "name": "เงินฝากออมทรัพย์"}], "accounttype": "asset", "normalbalance": "debit", "allowposting": true, "iscash": true, "isactive": true}'),
  ('01', 'accounts', 'acc-11300', '11300', 1, '{"accountcode": "11300", "name": "ลูกหนี้การค้า", "names": [{"code": "th", "name": "ลูกหนี้การค้า"}], "accounttype": "asset", "normalbalance": "debit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-11400', '11400', 1, '{"accountcode": "11400", "name": "สินค้าคงเหลือ", "names": [{"code": "th", "name": "สินค้าคงเหลือ"}], "accounttype": "asset", "normalbalance": "debit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-11500', '11500', 1, '{"accountcode": "11500", "name": "ภาษีซื้อ", "names": [{"code": "th", "name": "ภาษีซื้อ"}], "accounttype": "asset", "normalbalance": "debit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-12000', '12000', 1, '{"accountcode": "12000", "name": "อาคารและอุปกรณ์", "names": [{"code": "th", "name": "อาคารและอุปกรณ์"}], "accounttype": "asset", "normalbalance": "debit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-12100', '12100', 1, '{"accountcode": "12100", "name": "ค่าเสื่อมราคาสะสม-อาคารและอุปกรณ์", "names": [{"code": "th", "name": "ค่าเสื่อมราคาสะสม-อาคารและอุปกรณ์"}], "accounttype": "asset", "normalbalance": "credit", "allowposting": true, "iscash": false, "isactive": true}'),
  
  -- หมวด 2 หหนี้สิน
  ('01', 'accounts', 'acc-21000', '21000', 1, '{"accountcode": "21000", "name": "เจ้าหนี้การค้า", "names": [{"code": "th", "name": "เจ้าหนี้การค้า"}], "accounttype": "liability", "normalbalance": "credit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-21100', '21100', 1, '{"accountcode": "21100", "name": "ค่าใช้จ่ายค้างจ่าย", "names": [{"code": "th", "name": "ค่าใช้จ่ายค้างจ่าย"}], "accounttype": "liability", "normalbalance": "credit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-21200', '21200', 1, '{"accountcode": "21200", "name": "ภาษีขาย", "names": [{"code": "th", "name": "ภาษีขาย"}], "accounttype": "liability", "normalbalance": "credit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-21300', '21300', 1, '{"accountcode": "21300", "name": "ภาษีเงินได้หัก ณ ที่จ่ายค้างจ่าย", "names": [{"code": "th", "name": "ภาษีเงินได้หัก ณ ที่จ่ายค้างจ่าย"}], "accounttype": "liability", "normalbalance": "credit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-22000', '22000', 1, '{"accountcode": "22000", "name": "เงินกู้ยืมระยะยาวจากสถาบันการเงิน", "names": [{"code": "th", "name": "เงินกู้ยืมระยะยาวจากสถาบันการเงิน"}], "accounttype": "liability", "normalbalance": "credit", "allowposting": true, "iscash": false, "isactive": true}'),

  -- หมวด 3 ส่วนของเจ้าของ
  ('01', 'accounts', 'acc-31000', '31000', 1, '{"accountcode": "31000", "name": "ทุนจดทะเบียน", "names": [{"code": "th", "name": "ทุนจดทะเบียน"}], "accounttype": "equity", "normalbalance": "credit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-32000', '32000', 1, '{"accountcode": "32000", "name": "กำไรสะสม", "names": [{"code": "th", "name": "กำไรสะสม"}], "accounttype": "equity", "normalbalance": "credit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-33000', '33000', 1, '{"accountcode": "33000", "name": "กำไร(ขาดทุน)สุทธิประจำงวด", "names": [{"code": "th", "name": "กำไร(ขาดทุน)สุทธิประจำงวด"}], "accounttype": "equity", "normalbalance": "credit", "allowposting": true, "iscash": false, "isactive": true}'),

  -- หมวด 4 รายได้
  ('01', 'accounts', 'acc-41000', '41000', 1, '{"accountcode": "41000", "name": "รายได้จากการขายสินค้า", "names": [{"code": "th", "name": "รายได้จากการขายสินค้า"}], "accounttype": "income", "normalbalance": "credit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-41100', '41100', 1, '{"accountcode": "41100", "name": "รายได้จากการให้บริการ", "names": [{"code": "th", "name": "รายได้จากการให้บริการ"}], "accounttype": "income", "normalbalance": "credit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-42000', '42000', 1, '{"accountcode": "42000", "name": "รายได้อื่น", "names": [{"code": "th", "name": "รายได้อื่น"}], "accounttype": "income", "normalbalance": "credit", "allowposting": true, "iscash": false, "isactive": true}'),

  -- หมวด 5 ค่าใช้จ่าย
  ('01', 'accounts', 'acc-51000', '51000', 1, '{"accountcode": "51000", "name": "ต้นทุนขายสินค้า", "names": [{"code": "th", "name": "ต้นทุนขายสินค้า"}], "accounttype": "expense", "normalbalance": "debit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-52000', '52000', 1, '{"accountcode": "52000", "name": "เงินเดือนและค่าแรงพนักงาน", "names": [{"code": "th", "name": "เงินเดือนและค่าแรงพนักงาน"}], "accounttype": "expense", "normalbalance": "debit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-52100', '52100', 1, '{"accountcode": "52100", "name": "ค่าเช่าสำนักงานและคลังสินค้า", "names": [{"code": "th", "name": "ค่าเช่าสำนักงานและคลังสินค้า"}], "accounttype": "expense", "normalbalance": "debit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-52200', '52200', 1, '{"accountcode": "52200", "name": "ค่าไฟฟ้าและน้ำประปา", "names": [{"code": "th", "name": "ค่าไฟฟ้าและน้ำประปา"}], "accounttype": "expense", "normalbalance": "debit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-52300', '52300', 1, '{"accountcode": "52300", "name": "ค่าโทรศัพท์และอินเทอร์เน็ต", "names": [{"code": "th", "name": "ค่าโทรศัพท์และอินเทอร์เน็ต"}], "accounttype": "expense", "normalbalance": "debit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-52400', '52400', 1, '{"accountcode": "52400", "name": "ค่าเสื่อมราคา-อาคารและอุปกรณ์", "names": [{"code": "th", "name": "ค่าเสื่อมราคา-อาคารและอุปกรณ์"}], "accounttype": "expense", "normalbalance": "debit", "allowposting": true, "iscash": false, "isactive": true}'),
  ('01', 'accounts', 'acc-52500', '52500', 1, '{"accountcode": "52500", "name": "ดอกเบี้ยจ่าย", "names": [{"code": "th", "name": "ดอกเบี้ยจ่าย"}], "accounttype": "expense", "normalbalance": "debit", "allowposting": true, "iscash": false, "isactive": true}');
