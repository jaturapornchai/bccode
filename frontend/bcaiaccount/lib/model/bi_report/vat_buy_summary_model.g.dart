...
part of 'vat_buy_summary_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

VatBuySummary _$VatBuySummaryFromJson(Map<String, dynamic> json) =>
    VatBuySummary(
...
Map<String, dynamic> _$VatBuySummaryToJson(VatBuySummary instance) =>
    <String, dynamic>{
