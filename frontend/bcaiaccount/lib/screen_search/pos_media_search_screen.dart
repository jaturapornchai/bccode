...
class PosMediaSearchScreen extends StatefulWidget {
  const PosMediaSearchScreen({super.key, required this.word});
  final String word;
...
class PosMediaSearchScreenState extends State<PosMediaSearchScreen>
  ...
  void loadDataList(String search) {
    context.read<PosMediaBloc>().add(
      PosMediaLoadList(
        offset: (posMediaListData.isEmpty) ? 0 : posMediaListData.length,
          ...
          if (kIsWeb ||
            ...
            if (event is RawKeyDownEvent) {
              ...
              if (event.logicalKey == LogicalKeyboardKey.arrowUp) {
                isKeyDown = false;
                int index = posMediaListData.indexOf(
                  posMediaListData.firstWhere(
