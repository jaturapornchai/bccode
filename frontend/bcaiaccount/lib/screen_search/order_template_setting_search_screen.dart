...
class OrderTemplateSettingSearchScreen extends StatefulWidget {
  const OrderTemplateSettingSearchScreen({super.key, required this.word});
  final String word;

  @override
  State<OrderTemplateSettingSearchScreen> createState() =>
      OrderSettingSearchScreenState();
}

class OrderSettingSearchScreenState
    extends State<OrderTemplateSettingSearchScreen>
  ...
  void loadDataList(String search) {
    context.read<OrderTemplateSettingBloc>().add(
      OrderTemplateSettingLoadList(
        offset: (orderSettingListData.isEmpty)
            ? 0
            : orderSettingListData.length,
          ...
          if (kIsWeb ||
            ...
            if (event is RawKeyDownEvent) {
              ...
              if (event.logicalKey == LogicalKeyboardKey.arrowUp) {
                isKeyDown = false;
                int index = orderSettingListData.indexOf(
                  orderSettingListData.firstWhere(
              ...
              child: Row(
                children: [
                  Expanded(
                    flex: 5,
                    child: Text(
                      global.language("template_order_setting_code"),
                      style: TextStyle(
  ...
  Widget listObject(OrderTemplateSettingModel value, int index) {
