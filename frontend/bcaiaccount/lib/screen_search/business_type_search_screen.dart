...
class BusinessTypeSearchScreen extends StatefulWidget {
  const BusinessTypeSearchScreen({super.key, required this.word});
  final String word;

  @override
  State<BusinessTypeSearchScreen> createState() =>
      BusinessTypeSearchScreenState();
}

class BusinessTypeSearchScreenState extends State<BusinessTypeSearchScreen>
  ...
  void loadDataList(String search) {
    context.read<BusinessTypeBloc>().add(
      BusinessTypeLoadList(
        offset: (businessTypetListData.isEmpty)
            ? 0
            : businessTypetListData.length,
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pop(
              context,
              BusinessTypeModel(code: '', names: [], guidfixed: ''),
            );
          },
        ),
      ),
          ...
          if (kIsWeb ||
            ...
            if (event is RawKeyDownEvent) {
              ...
              if (event.logicalKey == LogicalKeyboardKey.arrowUp) {
                isKeyDown = false;
                int index = businessTypetListData.indexOf(
                  businessTypetListData.firstWhere(
          ...
          children: [
              ...
              child: Row(
                children: [
                  Expanded(
                    flex: 5,
                    child: Text(
                      global.language("business_type_code"),
                      style: TextStyle(
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: businessTypetListData
  ...
  Widget listObject(BusinessTypeModel value, int index) {
