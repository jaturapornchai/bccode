...
class CompanyBranchSearchScreen extends StatefulWidget {
  const CompanyBranchSearchScreen({super.key, required this.word});
  final String word;

  @override
  State<CompanyBranchSearchScreen> createState() =>
      CompanyBranchSearchScreenState();
}

class CompanyBranchSearchScreenState extends State<CompanyBranchSearchScreen>
          ...
          if (kIsWeb ||
            ...
            if (event is RawKeyDownEvent) {
              ...
              if (event.logicalKey == LogicalKeyboardKey.arrowUp) {
                isKeyDown = false;
                int index = companyBranchListData.indexOf(
                  companyBranchListData.firstWhere(
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: companyBranchListData
  ...
  Widget listObject(CompanyBranchModel value, int index) {
