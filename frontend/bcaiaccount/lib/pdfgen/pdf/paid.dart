          ...
          children: [
            ...
            pw.Expanded(
              child: pw.Column(
                ...
                children: [
                  pw.Text(
                    global.language('pdf_receiver_sign'),
                    style: const pw.TextStyle(
                      fontSize: 14,
                      color: PdfColors.black,
                    ),
...
pw.Widget _contentFooter(
    pw.Context context, TransactionPaidPayModel screenData) {
  return pw.Column(
    children: [
      pw.Row(
        crossAxisAlignment: pw.CrossAxisAlignment.start,
...
pw.Widget _contentTable(
  ...
  return pw.TableHelper.fromTextArray(
    ...
    data: List<List<String>>.generate(
      ...
      (row) {
        var filteredDetail = screenData.details!
...
String _cellValue(int rowIndex, int columnIndex,
    TransactionPaidPayDetailModel filteredDetail) {
  switch (columnIndex) {
    case 0:
      return '${rowIndex + 1}';
    case 1:
    ...
    case 2:
      return (global.profileData.yeartype == "buddhist")
          ? global.dateTimeBuddhist(DateTime.parse(filteredDetail.docdatetime),
              format: global.DateTimeFormatEnum.date)
          : DateFormat('dd/MM/yyyy')
              .format(DateTime.parse(filteredDetail.docdatetime));
    case 3:
