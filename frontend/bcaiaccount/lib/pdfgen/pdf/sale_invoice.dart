...
class Invoice {
        ...
        children: [
          ...
          pw.Expanded(
            child: pw.Column(
              ...
              children: [
                pw.Text(
                  global.language('pdf_goods_receiver'),
                  style: pw.TextStyle(
                    fontSize: 12,
                ...
                pw.Text(
                  global.language('pdf_date_sign_short2'),
          ...
          pw.Expanded(
            child: pw.Column(
              ...
              children: [
                pw.Text(
                  global.language('pdf_goods_sender'),
                  style: pw.TextStyle(
                    fontSize: 12,
                    fontWeight: pw.FontWeight.bold,
                    color: PdfColors.black,
          ...
          pw.Expanded(
            child: pw.Column(
              ...
              children: [
                pw.Text(
                  global.language('pdf_money_receiver'),
                  style: pw.TextStyle(
                    fontSize: 12,
                    fontWeight: pw.FontWeight.bold,
                    color: PdfColors.black,
          ...
          pw.Expanded(
            child: pw.Column(
              ...
              children: [
                pw.Text(
                  '${global.language("pdf_on_behalf_of")} ${global.activeLangName(companyBranchData.companynames)}',
                  style: pw.TextStyle(
                    fontSize: 12,
                    fontWeight: pw.FontWeight.bold,
                    color: PdfColors.black,
  ...
  pw.Widget _buildHeader(
      pw.Context context, Uint8List? logoBytes, TransactionModel screenData) {
    return pw.Column(
      children: [
  ...
  pw.Widget _buildCustomerDetails() {
    return _buildDetailBox(
      width: 337,
      children: [
        _detailRowCust(global.language('buyer'),
  ...
  pw.Widget _buildDocumentDetails() {
    return _buildDetailBox(
      ...
      children: [
        ...
        _detailRow(global.language('vat_num'), screenData.taxdocno),
        _detailRow(
          global.language('pdf_vat_date'),
          (screenData.taxdocno.isNotEmpty)
              ? (global.profileData.yeartype == "buddhist")
                  ? global.dateTimeBuddhist(
                      DateTime.parse(screenData.taxdocdate),
                      format: global.DateTimeFormatEnum.date)
                  : DateFormat('dd/MM/yyyy')
                      .format(DateTime.parse(screenData.taxdocdate))
              : '',
        ),
      ],
    );
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Row(
                    ...
                    children: [
                      pw.Expanded(
                        child: pw.Text(global.language('pdf_total_incl_vat')),
                      ),
                      pw.Expanded(
                        child: pw.Text(
                  ...
                  pw.Container(
                    ...
                    child: pw.Row(
                      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                      children: [
                        pw.Text(global.language('pdf_less_bill_discount')),
