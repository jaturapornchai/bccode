                    ...
                    child: pw.Container(
                      child: pw.Container(
                        ...
                        child: pw.Row(
                          mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                          children: [
                            pw.Text(global.language('payment_daily_total_amount_column')),
                            pw.Text(
...
List<List<String>> _generateTableData(
    TransactionModel screenData, int columnCount) {
...
String _cellValue(int rowIndex, int columnIndex, TransactionModel screenData,
  ...
  if (isDescription) {
    ...
    return columnIndex == 2
        ? "${global.language("remark")}: ${screenData.details![rowIndex].description}"
        : "";
  }
