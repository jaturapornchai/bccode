            ...
            pw.Expanded(
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Text(
                    global.language('pdf_date_sign_medium2'),
                    style: const pw.TextStyle(
                      fontSize: 14,
                      color: PdfColors.black,
                    ),
    ...
    return pw.Column(
      children: [
        ...
        pw.Padding(
          ...
          child: pw.Text(
            global.language("pdf_stock_transfer"),
            style: pw.TextStyle(
              fontSize: 20,
    ...
    return _buildDetailBox(
      ...
      children: [
        _detailRow(
          ...
          (global.profileData.yeartype == "buddhist")
              ? global.dateTimeBuddhist(DateTime.parse(screenData.docrefdate),
                  format: global.DateTimeFormatEnum.date)
              : DateFormat('dd/MM/yyyy')
                  .format(DateTime.parse(screenData.docrefdate)),
        ),
        _detailRow(global.language('text_form_ref_invoice_number'),
            screenData.docrefno),
      ],
    );
  }
...
pw.Widget _contentTable(pw.Context context, TransactionModel screenData) {
  final tableHeaders = [
    ...
    global.language('pdf_warehouse_out'),
    global.language('pdf_location_out'),
    global.language('pdf_warehouse_in'),
    global.language('pdf_location_in'),
...
String _cellValue(int rowIndex, int columnIndex, TransactionModel screenData) {
  if (screenData.details![rowIndex].calcflag == -1) {
    switch (columnIndex) {
      ...
      case 4:
        return global
            .activeLangName(screenData.details![rowIndex].locationnames!);
      case 5:
        return global.activeLangName(screenData.details![rowIndex].towhnames!);
      case 6:
        return global
            .activeLangName(screenData.details![rowIndex].tolocationnames!);
      case 7:
