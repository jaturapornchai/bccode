  ...
  Widget listScreen({bool mobileScreen = false}) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          const ManualButton(path: 'product-class'),
          Padding(
                      ...
                      actions: <Widget>[
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.pop(context);
                            context.read<MasterClassBloc>().add(
                              MasterClassDeleteMany(guid: classGuidListChecked),
                            );
                          },
                ...
                if (event is RawKeyDownEvent) {
                  if (event.logicalKey == LogicalKeyboardKey.arrowUp) {
                    if (currentListIndex > 0) {
                      setState(() {
                        currentListIndex--;
                        listScrollController.jumpTo((currentListIndex) * 50.0);
                      });
                    }
                    ...
                    if (currentListIndex >= 0 &&
                      ...
                      if (showCheckBox == true) {
                        setState(() {
                          ...
                          if (classGuidListChecked.contains(value.guidfixed)) {
    ...
    if (screenEvent == global.ScreenEventEnum.edit ||
      ...
      if (verifyData(classData)) {
        ...
        if (selectGuid.trim().isEmpty) {
          context.read<MasterClassBloc>().add(
            MasterClassSave(classModel: classData),
          );
        } else {
          context.read<MasterClassBloc>().add(
            MasterClassUpdate(guid: selectGuid, classModel: classData),
          );
        }
      }
    }
