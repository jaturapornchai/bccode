...
class MasterGroupScreen extends StatefulWidget {
  const MasterGroupScreen({super.key});

  @override
  State<MasterGroupScreen> createState() => MasterGroupScreenState();
}

class MasterGroupScreenState extends State<MasterGroupScreen>
  ...
  Widget listScreen({bool mobileScreen = false}) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          const ManualButton(path: 'product-main-group'),
          Padding(
                      ...
                      actions: <Widget>[
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.pop(context);
                            context.read<MasterGroupBloc>().add(
                              MasterGroupDeleteMany(guid: groupGuidListChecked),
                            );
                          },
    ...
    if (screenEvent == global.ScreenEventEnum.edit ||
      ...
      if (verifyData(group)) {
        ...
        if (selectGuid.trim().isEmpty) {
          context.read<MasterGroupBloc>().add(
            MasterGroupSave(groupModel: group),
          );
        } else {
          context.read<MasterGroupBloc>().add(
            MasterGroupUpdate(guid: selectGuid, groupModel: group),
          );
        }
      }
    }
                      ...
                      actions: <Widget>[
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.pop(context);
                            context.read<MasterGroupBloc>().add(
                              MasterGroupDelete(guid: selectGuid),
                            );
                          },
                          child: Text(global.language('confirm')),
                        ),
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelText:
                            "${global.language("group_name")} (${languageList[i].name})",
