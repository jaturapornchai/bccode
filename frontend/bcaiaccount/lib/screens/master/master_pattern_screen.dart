...
class MasterPatternScreen extends StatefulWidget {
  const MasterPatternScreen({super.key});

  @override
  State<MasterPatternScreen> createState() => MasterPatternScreenState();
}

class MasterPatternScreenState extends State<MasterPatternScreen>
  ...
  Widget listScreen({bool mobileScreen = false}) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          const ManualButton(path: 'product-pattern'),
          Padding(
                      ...
                      actions: <Widget>[
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.pop(context);
                            context.read<MasterPatternBloc>().add(
                              MasterPatternDeleteMany(
                                guid: patternGuidListChecked,
                              ),
                            );
                          },
    ...
    if (screenEvent == global.ScreenEventEnum.edit ||
      ...
      if (verifyData(pattern)) {
        ...
        if (selectGuid.trim().isEmpty) {
          context.read<MasterPatternBloc>().add(
            MasterPatternSave(patternModel: pattern),
          );
        } else {
          context.read<MasterPatternBloc>().add(
            MasterPatternUpdate(guid: selectGuid, patternModel: pattern),
          );
        }
      }
    }
                      ...
                      actions: <Widget>[
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.pop(context);
                            context.read<MasterPatternBloc>().add(
                              MasterPatternDelete(guid: selectGuid),
                            );
                          },
                          child: Text(global.language('confirm')),
                        ),
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: const OutlineInputBorder(),
                        labelText:
                            "${global.language("pattern_name")} (${languageList[i].name})",
