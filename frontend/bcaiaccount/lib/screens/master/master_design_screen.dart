...
class MasterDesignScreen extends StatefulWidget {
  const MasterDesignScreen({super.key});
  ...
  Widget listScreen({bool mobileScreen = false}) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          const ManualButton(path: 'product-design'),
          Padding(
    ...
    if (screenEvent == global.ScreenEventEnum.edit ||
      ...
      if (verifyData(design)) {
        ...
        if (selectGuid.trim().isEmpty) {
          context.read<MasterDesignBloc>().add(
            MasterDesignSave(designModel: design),
          );
        } else {
          context.read<MasterDesignBloc>().add(
            MasterDesignUpdate(guid: selectGuid, designModel: design),
          );
        }
      }
    }
