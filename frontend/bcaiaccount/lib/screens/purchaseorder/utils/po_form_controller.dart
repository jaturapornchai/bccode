...
/// Controller สำหรับจัดการ TextEditingController ทั้งหมดในหน้าจอ PO
///
/// รับผิดชอบ:
...
class POFormController {
  ...
  DateTime _safeParseDatetime(String? dateString) {
    ...
    try {
      ...
      AppLogger.warning('[POFormController] แปลงวันที่ไม่สำเร็จ: "$dateString" → ใช้ DateTime.now() แทน');
      return DateTime.now();
    }
  }
