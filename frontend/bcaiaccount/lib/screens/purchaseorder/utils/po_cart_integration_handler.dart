...
/// Handler สำหรับจัดการการรับข้อมูลจากระบบตะกร้าสินค้า
///
/// รับผิดชอบ:
...
class POCartIntegrationHandler {
  /// ตรวจสอบและดึง CartTransferModel จาก context
  /// Returns null ถ้าไม่พบข้อมูล
  ...
  ///
  /// [screenData] - TransactionModel ที่จะอัพเดท
  /// [cartTransfer] - ข้อมูลจากตะกร้า
  /// [calcflag] - flag สำหรับคำนวณ
  ///
  /// Returns TransactionModel ที่อัพเดทแล้ว
