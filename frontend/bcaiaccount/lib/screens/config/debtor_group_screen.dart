...
class DebtorGroupScreen extends StatefulWidget {
  const DebtorGroupScreen({super.key});

  @override
  State<DebtorGroupScreen> createState() => DebtorGroupScreenState();
}

class DebtorGroupScreenState extends State<DebtorGroupScreen>
                      ...
                      actions: <Widget>[
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.pop(context);
                            context.read<DebtorGroupBloc>().add(
                              DebtorGroupDeleteMany(
                                guid: debtorGroupGuidListChecked,
                              ),
                            );
                          },
    ...
    if (screenEvent == global.ScreenEventEnum.edit ||
      ...
      if (verifyData(debtorGroupModel)) {
        ...
        if (selectGuid.trim().isEmpty) {
          context.read<DebtorGroupBloc>().add(
            DebtorGroupSave(debtorGroups: debtorGroupModel),
          );
        } else {
          showCheckBox = false;
          context.read<DebtorGroupBloc>().add(
            DebtorGroupUpdate(guid: selectGuid, debtorGroups: debtorGroupModel),
          );
        }
      }
    }
                      ...
                      actions: <Widget>[
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.pop(context);
                            context.read<DebtorGroupBloc>().add(
                              DebtorGroupDelete(guid: selectGuid),
                            );
                          },
                          child: Text(global.language('confirm')),
                        ),
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            labelText:
                                "${global.language("debtor_name")} (${languageList[i].name})",
                          ),
                        ),
                      ),
                    if (isSaveAllow)
