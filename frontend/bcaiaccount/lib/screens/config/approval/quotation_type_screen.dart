...
/// หน้าจอประเภทใบเสนอราคา (Quotation Type Screen)
/// จัดการประเภทใบเสนอราคา เช่น เสนอราคาทั่วไป, เสนอราคาพิเศษ
class QuotationTypeScreen extends StatefulWidget {
  const QuotationTypeScreen({super.key});

  @override
  State<QuotationTypeScreen> createState() => _QuotationTypeScreenState();
}

class _QuotationTypeScreenState extends State<QuotationTypeScreen> {
        ...
        title: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.request_quote_outlined, size: 20),
            ),
            SizedBox(width: 12),
            Text(global.language('quotation_type')),
          ],
        ),
        leading: IconButton(
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                icon: Icon(Icons.add),
                label: Text(global.language('add_new_quotation_type')),
                style: ElevatedButton.styleFrom(
                  backgroundColor: global.theme.appBarColor,
                  foregroundColor: Colors.white,
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                _selectedItem == null
                                    ? global.language('add_new_quotation_type')
                    ...
                    _buildTextField(
                      ...
                      hint: global.language('eg_general_special_quotation'),
