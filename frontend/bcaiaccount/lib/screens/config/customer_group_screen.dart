...
class CustomerGroupScreenState extends State<CustomerGroupScreen>
  ...
  CustomerGroupModel dataTemp = CustomerGroupModel(
    guidfixed: '',
    groupcode: '',
  );
                          ...
                          onPressed: () {
                            ...
                            context.read<CustomerGroupBloc>().add(
                              CustomerGroupDeleteMany(
                                guid: CustomerGroupGuidListChecked,
                              ),
                            );
                          },
    ...
    if (screenEvent == global.ScreenEventEnum.edit ||
      ...
      if (verifyData(customerGroupModel)) {
        ...
        if (selectGuid.trim().isEmpty) {
          context.read<CustomerGroupBloc>().add(
            CustomerGroupSave(customerGroup: customerGroupModel),
          );
        } else {
          showCheckBox = false;
          context.read<CustomerGroupBloc>().add(
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelText:
                            "${global.language("customer_name")} (${languageList[i].name})",
                      ),
                    ),
                  ),
                if (isSaveAllow)
