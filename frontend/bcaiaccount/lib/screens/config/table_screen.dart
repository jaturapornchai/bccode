...
class TableScreen extends StatefulWidget {
  ...
  const TableScreen({super.key, required this.groupnumber});
...
class TableScreenState extends State<TableScreen>
  ...
  void loadDataToScreen() {
    ...
    zoneSelected = listDataZone.firstWhere(
      (element) => element.code == screenData.zone,
      orElse: () => ZoneDataModel(code: '', names: [], guidfixed: ''),
    );
  }
                      ...
                      actions: <Widget>[
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.pop(context);
                            context.read<TableBloc>().add(
                              TableDeleteMany(guid: guidListChecked),
                            );
                          },
  ...
  void updateData(String guid) {
    ...
    context.read<TableBloc>().add(
      TableUpdate(guid: guid, tableModel: screenData),
    );
  }
      ...
      Padding(
        ...
        child: TextFormField(
          ...
          controller: TextEditingController(
            text: screenData.groupnumber.toString(),
          ),
        ...
        Padding(
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              labelText:
                  "${global.language("Table_name")} (${getLangName(screenData.names[languageIndex].code)})",
            ),
            validator: (value) {
              if (languageIndex == 0) {
                if (value == null || value.isEmpty) {
          ...
          children: [
                    ...
                    child: DropdownButton<int>(
                      ...
                      items: global.groupNumber.map<DropdownMenuItem<int>>((
                        ...
                        return DropdownMenuItem<int>(
                          value: value.toInt(),
                          child: Text(
                            "${global.language("group_number")} ${value.toInt()}",
                          ),
                        );
                      }).toList(),
                    ),
            ...
            Expanded(
              child: DropdownSearch<ZoneDataModel>(
                ...
                items: (String filter, infiniteScrollProps) => getDataZone(filter),
