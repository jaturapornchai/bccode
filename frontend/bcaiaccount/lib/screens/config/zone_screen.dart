...
class ZoneScreen extends StatefulWidget {
  ...
  const ZoneScreen({super.key, required this.groupnumber});

  @override
  State<ZoneScreen> createState() => ZoneScreenState();
}

class ZoneScreenState extends State<ZoneScreen>
                      ...
                      actions: <Widget>[
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.pop(context);
                            context.read<ZoneBloc>().add(
                              ZoneDeleteMany(guid: guidListChecked),
                            );
                          },
  ...
  void updateData(String guid) {
    ...
    context.read<ZoneBloc>().add(
      ZoneUpdate(guid: guid, zoneDataModel: screenData),
    );
  }
        ...
        Padding(
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              labelText:
                  "${global.language("Zone_name")} (${getLangName(screenData.names[languageIndex].code)})",
            ),
            validator: (value) {
              if (languageIndex == 0) {
                if (value == null || value.isEmpty) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: mobileScreen
            ...
            : null,
        title: Text(
          "$headerEdit${global.language("Zone")} ${widget.groupnumber}",
        ),
        actions: <Widget>[
