...
class SegmentedButton<T> extends StatefulWidget {
  ...
  /// [WidgetStateProperty] [ButtonStyle.foregroundColor].
  ///
  ...
  static ButtonStyle styleFrom({
    ...
    final WidgetStateProperty<Color?>? overlayColor = (foregroundColor == null)
        ? null
...
class SegmentedButtonState<T> extends State<SegmentedButton<T>> {
  ...
  @visibleForTesting
  final Map<ButtonSegment<T>, WidgetStatesController> statesControllers =
      <ButtonSegment<T>, WidgetStatesController>{};
  ...
  Widget build(BuildContext context) {
    ...
    final Set<WidgetState> currentState = _enabled
        ? enabledState
        : disabledState;
    ...
    Widget buttonFor(ButtonSegment<T> segment) {
      ...
      final Widget? icon = (segmentSelected && widget.showSelectedIcon)
          ...
          ? segment.icon
          : null;
      final WidgetStatesController controller = statesControllers.putIfAbsent(
        segment,
        () => WidgetStatesController(),
      );
      controller.value = <WidgetState>{
        if (segmentSelected) WidgetState.selected,
      };
...
@immutable
class _SegmentedButtonDefaultOverlay extends WidgetStateProperty<Color?>
    with Diagnosticable {
...
@immutable
class _SegmentButtonDefaultColor extends WidgetStateProperty<Color?>
    with Diagnosticable {
