...
class ProductLabelPrintShelf {
  ...
  static Future<void> showPdfPreview(
    ...
    try {
      ...
      pdfBytes = await generatePdf(context, productsToPrint, showImages);
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () =>
                  Navigator.pop(context, {'showImages': showImages}),
    ...
    return pw.Padding(
      ...
      child: pw.GridView(
        ...
        children: List.generate(
          _itemsPerPage,
          (index) =>
              _buildProductCell(products, startIndex + index, showImages),
        ),
      ),
    );
  }
