...
const lineOaText: Partial<Record<LanguageCode, Partial<Record<LineOaTextKey, string>>>> = {
  th: {
    ...
    subtitle: "ผูกผู้ใช้ของกิจการที่เลือกกับ LINE OA สำหรับแจ้งเตือนและอนุมัติเอกสาร",
    currentUser: "ผู้ใช้ปัจจุบัน",
    selectedCompany: "กิจการที่เลือก",
    ...
    loginRequired: "กรุณาเข้าสู่ระบบและเลือกกิจการก่อนเปิดหน้าจอนี้",
    setupRequired: "กิจการนี้ยังไม่ได้ตั้งค่า LINE OA หรือ LIFF ID",
    secureNote: "ผูกระดับ user เฉพาะกิจการที่ใช้งานอยู่",
    stepCompany: "กิจการ",
    stepGenerate: "ลิงก์",
    stepConfirm: "ยืนยัน",
    none: "ไม่มี",
