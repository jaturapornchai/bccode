...
const holdingTextEn: Record<HoldingTextKey, string> = {
  ...
  edit: "Edit",
  emailLoginRequired: "Link a valid email to your account before creating a business group.",
...
const holdingText: Record<LanguageCode, Record<HoldingTextKey, string>> = {
  th: {
    ...
    edit: "แก้ไข",
    emailLoginRequired: "ต้องเชื่อมอีเมลที่ถูกต้องกับบัญชีก่อนสร้างกลุ่มกิจการ",
  ...
  cn: {
    ...
    edit: "编辑",
    emailLoginRequired: "创建集团前，请先为账户关联有效邮箱。",
  ...
  ja: {
    ...
    edit: "編集",
    emailLoginRequired: "企業グループを作成する前に、有効なメールアドレスをアカウントに連携してください。",
  ...
  ko: {
    ...
    edit: "수정",
    emailLoginRequired: "사업 그룹을 만들기 전에 계정에 유효한 이메일을 연결하세요.",
  ...
  lo: {
    ...
    edit: "ແກ້ໄຂ",
    emailLoginRequired: "ຕ້ອງເຊື່ອມອີເມວທີ່ຖືກຕ້ອງກັບບັນຊີກ່ອນສ້າງກຸ່ມທຸລະກິດ.",
  ...
  my: {
    ...
    edit: "ပြင်ရန်",
    emailLoginRequired: "စီးပွားရေးလုပ်ငန်းအုပ်စု မဖန်တီးမီ မှန်ကန်သော အီးမေးလ်ကို အကောင့်နှင့် ချိတ်ဆက်ပါ။",
  ...
  km: {
    ...
    edit: "កែសម្រួល",
    emailLoginRequired: "សូមភ្ជាប់អ៊ីមែលត្រឹមត្រូវទៅគណនី មុនពេលបង្កើតក្រុមអាជីវកម្ម។",
  ...
  vi: {
    ...
    edit: "Sửa",
    emailLoginRequired: "Hãy liên kết email hợp lệ với tài khoản trước khi tạo nhóm doanh nghiệp.",
  ...
  ms: {
    ...
    edit: "Edit",
    emailLoginRequired: "Pautkan e-mel yang sah kepada akaun sebelum mencipta kumpulan perniagaan.",
  ...
  id: {
    ...
    edit: "Edit",
    emailLoginRequired: "Tautkan email yang valid ke akun sebelum membuat grup bisnis.",
  ...
  fil: {
    ...
    edit: "I-edit",
    emailLoginRequired: "Mag-link ng wastong email sa account bago gumawa ng grupo ng negosyo.",
