...
const CHAMP_SEARCH_ALIASES: Record<string, string[]> = {
  ...
  "director-advance": ["บันทึกขอเบิกเงินทดรองจ่าย"],
  "employee-advance": ["บันทึกขอเบิกเงินทดรองจ่าย"],
  "expense-record": ["บันทึกจ่ายเงินอื่นๆ"],
  "expiring-stock-alert": ["รายงานยอดคงเหลือสินค้าที่ถึงจุดสูงสุด"],
  ...
  "purchase-price-comparison": ["รายงานเปรียบเทียบราคาซื้อ"],
  ...
  "stock-movement-cost": ["รายงานเคลื่อนไหวสินค้าต้นทุนมาตรฐาน"],
  ...
  "uv-journal": ["กำหนดสมุดรายวัน"],
  "withholding-tax-deduction": ["พิมพ์ภาษีหัก ณ ที่จ่าย (ภ.ง.ด. 3,ภ.ง.ด. 53)"],
  "withholding-tax-received": ["รายงานภาษีถูกหัก ณ ที่จ่าย"],
