...
export const themeStorageKey = "bc_theme";
export const colorThemeStorageKey = "bc_color_theme";
export const defaultColorTheme: ColorThemeId = "ban-chiang";
...
export function applyVisualTheme(themeMode: ThemeMode, colorTheme: ColorThemeId) {
...
export function getThemesMap(): Record<string, Record<string, ThemeVars>> {
  const map: Record<string, Record<string, ThemeVars>> = {};
