...
export const FA_LABELS = {
  assetRegistry: { th: "ทะเบียนสินทรัพย์ถาวร", en: "Fixed Asset Registry" },
  depreciationCalc: { th: "คำนวณค่าเสื่อมราคา", en: "Calculate Depreciation" },
  ...
  assetTypes: { th: "ประเภทสินทรัพย์", en: "Asset Types" },
  ...
  usefulLife: { th: "อายุการใช้งาน (ปี)", en: "Useful Life (Years)" },
  deprecRate: { th: "อัตราค่าเสื่อม (%)", en: "Depreciation Rate (%)" },
