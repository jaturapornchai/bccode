...
export const SYSTEM_SETTING_CONFIGS: SystemSettingConfig[] = [
  ...
  },
  {
    ...
    fields: [
      textField("group_code", "รหัสกลุ่มสิทธิ์", "Group code", true),
...
function productMasterConfigs(): SystemSettingConfig[] {
  ...
  const serialRegistryStatusOptions: SystemSettingOption[] = [
    { value: "in_stock", label: "In stock", labels: { th: "อยู่ในสต๊อก", en: "In stock" } },
  ...
  return [
    {
      ...
      fields: [
        textField("unit_code", "รหัสหน่วยนับ", "Unit code", true),
    ...
    atlasMasterConfig(
      "product_serial_registry",
      "/product_serial_registry",
      "qr",
      "product_serial_registries",
      "ทะเบียนเลขเครื่อง",
      "Serial Registry",
      ...
      [
        textField("serial_no", "เลขเครื่อง", "Serial / identifier", true),
        selectField("identifier_type", "ประเภทเลขเครื่อง", "Identifier type", serialTrackingModeOptions),
        selectField("status", "สถานะเลขเครื่อง", "Serial status", serialRegistryStatusOptions),
        textField("item_code", "รหัสสินค้า", "Product code", true),
        textField("barcode", "บาร์โค้ด/SKU", "Barcode / SKU"),
        textField("sku_code", "รหัส SKU", "SKU code"),
        textField("unit_code", "หน่วยนับ", "Unit code"),
        textField("warehouse_code", "คลัง", "Warehouse"),
        textField("location_code", "โซน/ชั้นวาง", "Location / shelf"),
        textField("supplier_code", "ผู้จำหน่าย", "Supplier"),
        textField("customer_code", "ลูกค้า", "Customer"),
        textField("purchase_doc_no", "เอกสารซื้อ", "Purchase document"),
        textField("sale_doc_no", "เอกสารขาย", "Sale document"),
        dateField("warranty_start_date", "เริ่มประกัน", "Warranty start"),
        dateField("warranty_end_date", "หมดประกัน", "Warranty end"),
    ...
    atlasMasterConfig(
      ...
      [
        textField("price_code", "รหัสราคา", "Price code", true),
        namesField("names", "ชื่อราคา", "Price names"),
        textField("channel_code", "ช่องทางขาย", "Sales channel", true),
        textField("item_code", "รหัสสินค้า", "Product code", true),
        textField("barcode", "บาร์โค้ด/SKU", "Barcode / SKU"),
        textField("dimension_key", "ตัวเลือกสินค้า", "Product option key"),
        textField("price_level", "ระดับราคา", "Price level"),
        textField("currency", "สกุลเงิน", "Currency"),
        numberField("sale_price", "ราคาขาย", "Sale price"),
        numberField("compare_at_price", "ราคาเต็ม/ก่อนลด", "Compare-at price"),
        dateField("start_date", "เริ่มใช้ราคา", "Start date"),
        dateField("end_date", "สิ้นสุดราคา", "End date"),
        selectField("status", "สถานะราคา", "Price status", channelPriceStatusOptions),
        checkboxField("sync_price", "ซิงค์ราคากับช่องทางขาย", "Sync channel price"),
        companyMultiSelectField("business_codes", "สิทธิ์การเข้าถึงบริษัท", "Active companies"),
        checkboxField("isdisabled", "ปิดใช้งาน", "Disabled"),
      ],
    ),
