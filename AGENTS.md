...
1. **ผังบัญชี (Chart of Accounts) ต้องใช้ชื่อมาตรฐานวิชาชีพบัญชีไทยแท้จริง**:
   ...
   - **ต้องใช้ชื่อมาตรฐานสภาวิชาชีพบัญชี / DBD / กรมสรรพากร**:
     - หมวด 1 สินทรัพย์: สินทรัพย์, สินทรัพย์หมุนเวียน, เงินสดหน้าร้าน, เงินฝากกระแสรายวัน, เงินสดย่อย, ลูกหนี้การค้า, สินค้าคงเหลือ (ปูนซีเมนต์, เหล็กเส้น, สีทาอาคาร), ภาษีซื้อ, เบี้ยประกันภัยจ่ายล่วงหน้า, อาคารและอุปกรณ์, ยานพาหนะ, ค่าเสื่อมราคาสะสม
     - หมวด 2 หนี้สิน: หนี้สิน, หนี้สินหมุนเวียน, เจ้าหนี้การค้า, ภาษีขาย, ค่าใช้จ่ายค้างจ่าย, เงินกู้ยืมระยะยาว
     - หมวด 3 ส่วนของเจ้าของ: ส่วนของเจ้าของ, ทุนจดทะเบียน/ทุนเจ้าของ, กำไรสะสม, กำไรขาดทุนรอจัดสรร
     - หมวด 4 รายได้: รายได้, รายได้จากการขาย (ปูนซีเมนต์, เหล็กเส้น, สีทาอาคาร), รับคืนสินค้าและส่วนลดจ่าย
     - หมวด 5 ค่าใช้จ่าย: ต้นทุนขาย (ปูนซีเมนต์, เหล็กเส้น, สีทาอาคาร), ค่าไฟฟ้า, ค่าน้ำมันเชื้อเพลิง, ค่าเสื่อมราคา, ค่าเบี้ยประกันภัย, ดอกเบี้ยจ่าย, สินค้าชำรุดเสียหาย
