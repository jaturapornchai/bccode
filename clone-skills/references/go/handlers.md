...
## List Handler Template (complete)
...
// Request struct — json tags must match what Flutter sends
...
```go
// Add after existing routes (sorted by resource)
...
map[string]interface{}{"success": true, "id": guid, "message": "Saved successfully"}

// Error 400
map[string]interface{}{"status": "error", "message": "reason"}

// Error 500
map[string]interface{}{"status": "error", "message": "reason", "error": err.Error()}
```
