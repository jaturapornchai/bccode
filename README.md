...
4. **ชื่อฟิลด์ใช้คำเดียวกับของเดิม** — คู่ค้าฝั่งซื้อเรียก "เจ้าหนี้" ทุกจอและทุกรายงาน (เดิมสลับไปมาระหว่าง "ผู้จำหน่าย" กับ "เจ้าหนี้") และเปลี่ยน "เลขผู้เสียภาษี" เป็น "เลขประจำตัวผู้เสียภาษี" ตามคำที่ใช้ในเอกสารราชการ
