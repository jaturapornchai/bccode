...
var schemaStatements = []string{
	...
	// ที่อยู่สำหรับภาษี (สำนักงานใหญ่) แยกช่องเท่ากับ key หัวแบบ rdform + โทรศัพท์ — internal/taxaddress,
	// ADR docs/kms/decisions/2026-09-25-company-tax-address.md
	`ALTER TABLE companies ADD COLUMN IF NOT EXISTS addr_building TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE companies ADD COLUMN IF NOT EXISTS addr_room TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE companies ADD COLUMN IF NOT EXISTS addr_floor TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE companies ADD COLUMN IF NOT EXISTS addr_village TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE companies ADD COLUMN IF NOT EXISTS addr_no TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE companies ADD COLUMN IF NOT EXISTS addr_moo TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE companies ADD COLUMN IF NOT EXISTS addr_soi TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE companies ADD COLUMN IF NOT EXISTS addr_junction TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE companies ADD COLUMN IF NOT EXISTS addr_road TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE companies ADD COLUMN IF NOT EXISTS addr_subdistrict TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE companies ADD COLUMN IF NOT EXISTS addr_district TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE companies ADD COLUMN IF NOT EXISTS addr_province TEXT NOT NULL DEFAULT ''`,
	`ALTER TABLE companies ADD COLUMN IF NOT EXISTS addr_postcode TEXT NOT NULL DEFAULT ''`,
