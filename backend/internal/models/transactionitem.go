...
type TransItemDetail struct {
	...
	LineNumber int16     `json:"line_number" gorm:"column:line_number;uniqueIndex:transitemdetail_unique_dockey;type:smallint;default:0"` //
	...
	SumCost float64   `json:"sum_amount" gorm:"column:sum_amount"`
	VatType int16     `json:"vat_type" gorm:"column:vat_type;type:smallint;default:0"`
	TotalAmount float64   `json:"total_amount" gorm:"column:total_amount"`
