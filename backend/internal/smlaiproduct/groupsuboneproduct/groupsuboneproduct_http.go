...
func (h GroupsuboneProductHttp) CreateGroupsuboneProduct(ctx microservice.IContext) error {
	...
	idx, err := h.svc.CreateGroupsuboneProduct(holdingCode, authUsername, *docReq)
	if err != nil {
...
func (h GroupsuboneProductHttp) UpdateGroupsuboneProduct(ctx microservice.IContext) error {
	...
	err := h.svc.UpdateGroupsuboneProduct(holdingCode, id, authUsername, *docReq)
	if err != nil {
		ctx.ResponseError(http.StatusBadRequest, err.Error())
		return err
	}
...
func (h GroupsuboneProductHttp) DeleteGroupsuboneProduct(ctx microservice.IContext) error {
	...
	err := h.svc.DeleteGroupsuboneProduct(holdingCode, id, authUsername)
	if err != nil {
		ctx.ResponseError(http.StatusBadRequest, err.Error())
		return err
	}
...
func (h GroupsuboneProductHttp) DeleteGroupsuboneProductByGUIDs(ctx microservice.IContext) error {
	...
	err := h.svc.DeleteGroupsuboneProductByGUIDs(holdingCode, authUsername, docReq)
	if err != nil {
		ctx.ResponseError(http.StatusBadRequest, err.Error())
		return err
	}
...
func (h GroupsuboneProductHttp) InfoGroupsuboneProduct(ctx microservice.IContext) error {
	...
	doc, err := h.svc.InfoGroupsuboneProduct(holdingCode, id)
	if err != nil {
...
func (h GroupsuboneProductHttp) InfoGroupsuboneProductByCode(ctx microservice.IContext) error {
	...
	code := ctx.Param("code")
	doc, err := h.svc.InfoGroupsuboneProductByCode(holdingCode, code)
	if err != nil {
		ctx.ResponseError(http.StatusBadRequest, err.Error())
		return err
	}
...
func (h GroupsuboneProductHttp) SearchGroupsuboneProductPage(ctx microservice.IContext) error {
	...
	docList, pagination, err := h.svc.SearchGroupsuboneProduct(holdingCode, filter, pageable)
	if err != nil {
		ctx.ResponseError(http.StatusBadRequest, err.Error())
		return err
	}
...
func (h GroupsuboneProductHttp) SearchGroupsuboneProductStep(ctx microservice.IContext) error {
	...
	docList, total, err := h.svc.SearchGroupsuboneProductStep(holdingCode, lang, pageableStep)
	if err != nil {
		ctx.ResponseError(http.StatusBadRequest, err.Error())
		return err
	}
