...
func (h GradeProductHttp) CreateGradeProduct(ctx microservice.IContext) error {
	...
	idx, err := h.svc.CreateGradeProduct(shopID, authUsername, *docReq)
	if err != nil {
...
func (h GradeProductHttp) UpdateGradeProduct(ctx microservice.IContext) error {
	...
	err := h.svc.UpdateGradeProduct(shopID, id, authUsername, *docReq)
	if err != nil {
		ctx.ResponseError(http.StatusBadRequest, err.Error())
		return err
	}
...
func (h GradeProductHttp) DeleteGradeProduct(ctx microservice.IContext) error {
	...
	err := h.svc.DeleteGradeProduct(shopID, id, authUsername)
	if err != nil {
		ctx.ResponseError(http.StatusBadRequest, err.Error())
		return err
	}
...
func (h GradeProductHttp) DeleteGradeProductByGUIDs(ctx microservice.IContext) error {
	...
	err := h.svc.DeleteGradeProductByGUIDs(shopID, authUsername, docReq)
	if err != nil {
		ctx.ResponseError(http.StatusBadRequest, err.Error())
		return err
	}
...
func (h GradeProductHttp) InfoGradeProduct(ctx microservice.IContext) error {
	...
	doc, err := h.svc.InfoGradeProduct(shopID, id)
	if err != nil {
...
func (h GradeProductHttp) InfoGradeProductByCode(ctx microservice.IContext) error {
	...
	code := ctx.Param("code")
	doc, err := h.svc.InfoGradeProductByCode(shopID, code)
	if err != nil {
		ctx.ResponseError(http.StatusBadRequest, err.Error())
		return err
	}
...
func (h GradeProductHttp) SearchGradeProductPage(ctx microservice.IContext) error {
	...
	docList, pagination, err := h.svc.SearchGradeProduct(shopID, map[string]interface{}{}, pageable)
	if err != nil {
		ctx.ResponseError(http.StatusBadRequest, err.Error())
		return err
	}
...
func (h GradeProductHttp) SearchGradeProductStep(ctx microservice.IContext) error {
	...
	docList, total, err := h.svc.SearchGradeProductStep(shopID, lang, pageableStep)
	if err != nil {
		ctx.ResponseError(http.StatusBadRequest, err.Error())
		return err
	}
