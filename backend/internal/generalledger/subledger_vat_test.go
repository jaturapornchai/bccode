...
func TestSubledgerVatRejectsRowsOutsideVatSQLChecks(t *testing.T) {
	...
	cases := map[string]func(*SubledgerVat){
		...
		"branch 6 digits":            func(v *SubledgerVat) { v.PartnerBranchNo = "000001" },
		"branch not digits":          func(v *SubledgerVat) { v.PartnerBranchNo = "HQ" },
		"tax id with letter":         func(v *SubledgerVat) { v.PartnerTaxID = "0-1055-58012-34-X" },
