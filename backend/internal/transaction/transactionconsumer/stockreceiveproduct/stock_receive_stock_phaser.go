...
type StockReceiveStockPhaser struct{}

func (p StockReceiveStockPhaser) PhaseSingleDoc(doc models.StockReceiveProductTransactionPG) (*models.StockTransaction, error) {
