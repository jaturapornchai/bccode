...
type StockReturnStockPhaser struct{}

func (p StockReturnStockPhaser) PhaseSingleDoc(doc models.StockReturnProductTransactionPG) (*models.StockTransaction, error) {
