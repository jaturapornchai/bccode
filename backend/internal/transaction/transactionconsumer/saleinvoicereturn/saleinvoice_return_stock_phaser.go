...
type SaleInvoiceReturnTransactionStockPhaser struct{}

func (p SaleInvoiceReturnTransactionStockPhaser) PhaseSingleDoc(doc models.SaleInvoiceReturnTransactionPG) (*models.StockTransaction, error) {

	transaction, err := p.PhaseSaleInvoiceReturnStock(doc)
	if err != nil {
...
func (p SaleInvoiceReturnTransactionStockPhaser) PhaseSaleInvoiceReturnStock(doc models.SaleInvoiceReturnTransactionPG) (*models.StockTransaction, error) {
