...
type StockTransferStockPhaser struct{}

func (p StockTransferStockPhaser) PhaseSingleDoc(doc models.StockTransferTransactionPG) (*models.StockTransaction, error) {
