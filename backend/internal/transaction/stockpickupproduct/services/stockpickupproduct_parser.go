...
type StockPickupProductParser struct{}

func (StockPickupProductParser) ParseProductBarcode(detail trans_models.Detail, productBarcode productbarcode_models.ProductBarcodeInfo) trans_models.Detail {
