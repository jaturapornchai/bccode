...
type StockReturnProductParser struct{}

func (StockReturnProductParser) ParseProductBarcode(detail trans_models.Detail, productBarcode productbarcode_models.ProductBarcodeInfo) trans_models.Detail {
