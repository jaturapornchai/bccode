...
type StockBalanceDetailParser struct{}

func (StockBalanceDetailParser) ParseProductBarcode(detail trans_models.Detail, productBarcode productbarcode_models.ProductBarcodeInfo) trans_models.Detail {
