...
import (
	...
	"smlcloudplatform/internal/transaction/paid/repositories"
	"smlcloudplatform/internal/transaction/paid/services"
...
func (h PaidHttp) RegisterHttp() {
	...
	h.ms.GET("/transaction/paid", h.SearchPaidPage)
	h.ms.GET("/transaction/paid/list", h.SearchPaidStep)
	h.ms.POST("/transaction/paid", h.CreatePaid)
	h.ms.GET("/transaction/paid/:id", h.InfoPaid)
	h.ms.GET("/transaction/paid/code/:code", h.InfoPaidByCode)
	h.ms.PUT("/transaction/paid/:id", h.UpdatePaid)
	h.ms.DELETE("/transaction/paid/:id", h.DeletePaid)
	h.ms.DELETE("/transaction/paid", h.DeletePaidByGUIDs)
}
...
// @Tags		Paid
// @Param		id  path      string  true  "Paid ID"
// @Param		Paid  body      models.Paid  true  "Paid"
// @Accept 		json
// @Success		201	{object}	common.ResponseSuccessWithID
// @Failure		401 {object}	common.AuthResponseFailed
// @Security     AccessToken
// @Router /transaction/paid/{id} [put]
...
// @Description Delete Paid
// @Tags		Paid
// @Param		Paid  body      []string  true  "Paid GUIDs"
// @Accept 		json
// @Success		200	{object}	common.ResponseSuccessWithID
// @Failure		401 {object}	common.AuthResponseFailed
// @Security     AccessToken
...
// @Tags		Paid
// @Param		id  path      string  true  "Paid guidfixed"
// @Accept 		json
...
// Get Paid By Code godoc
// @Description get Paid info by Code
// @Tags		Paid
// @Param		code  path      string  true  "Paid Code"
// @Accept 		json
// @Success		200	{object}	common.ApiResponse
// @Failure		401 {object}	common.AuthResponseFailed
// @Security     AccessToken
...
func (h PaidHttp) SaveBulk(ctx microservice.IContext) error {
