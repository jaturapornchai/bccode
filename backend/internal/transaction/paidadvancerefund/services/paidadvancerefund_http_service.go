...
type PaidAdvanceRefundHttpService struct {
	repoMq           repositories.IPaidAdvanceRefundMessageQueueRepository
	repo             repositories.IPaidAdvanceRefundRepository
	repoCache        trancache.ICacheRepository
	cacheExpireDocNo time.Duration
	syncCacheRepo    mastersync.IMasterSyncCacheRepository
	services.ActivityService[models.PaidAdvanceRefundActivity, models.PaidAdvanceRefundDeleteActivity]
	contextTimeout time.Duration
}

func NewPaidAdvanceRefundHttpService(
	repo repositories.IPaidAdvanceRefundRepository,
	repoCache trancache.ICacheRepository,
	repoMq repositories.IPaidAdvanceRefundMessageQueueRepository,
	syncCacheRepo mastersync.IMasterSyncCacheRepository,
) *PaidAdvanceRefundHttpService {

	contextTimeout := time.Duration(15) * time.Second

	insSvc := &PaidAdvanceRefundHttpService{
		repo:             repo,
		repoMq:           repoMq,
		repoCache:        repoCache,
	...
	insSvc.ActivityService = services.NewActivityService[models.PaidAdvanceRefundActivity, models.PaidAdvanceRefundDeleteActivity](repo)

	return insSvc
}

func (svc PaidAdvanceRefundHttpService) getContextTimeout() (context.Context, context.CancelFunc) {
	return context.WithTimeout(context.Background(), svc.contextTimeout)
}

func (svc PaidAdvanceRefundHttpService) getDocNoPrefix(docDate time.Time) string {
...
func (svc PaidAdvanceRefundHttpService) InfoPaidAdvanceRefund(shopID string, guid string) (models.PaidAdvanceRefundInfo, error) {
	...
	if len(findDoc.GuidFixed) < 1 {
		return models.PaidAdvanceRefundInfo{}, errors.New("document not found")
	}
...
func (svc PaidAdvanceRefundHttpService) SaveInBatch(shopID string, authUsername string, dataList []models.PaidAdvanceRefund) (common.BulkImport, error) {
	...
	payloadList, payloadDuplicateList := importdata.FilterDuplicate[models.PaidAdvanceRefund](dataList, svc.getDocIDKey)
...
func (svc PaidAdvanceRefundHttpService) getDocIDKey(doc models.PaidAdvanceRefund) string {
	return doc.DocNo
}
...
func (svc PaidAdvanceRefundHttpService) GetModuleName() string {
	return "paidadvancerefund"
}
