...
type StockAdjustmenParser struct{}

func (StockAdjustmenParser) ParseProductBarcode(detail trans_models.Detail, productBarcode productbarcode_models.ProductBarcodeInfo) trans_models.Detail {
