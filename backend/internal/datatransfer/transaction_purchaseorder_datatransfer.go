...
type IPurchaseOrderDataTransferRepository interface {
	FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.PurchaseOrderDoc, mongopagination.PaginationData, error)
}
...
func (repo PurchaseOrderDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.PurchaseOrderDoc, mongopagination.PaginationData, error) {
...
func (pdt *PurchaseOrderDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
