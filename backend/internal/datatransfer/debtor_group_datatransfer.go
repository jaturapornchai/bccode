...
type IDebtorGroupDataTransferRepository interface {
	FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.DebtorGroupDoc, mongopagination.PaginationData, error)
}
...
func (repo DebtorGroupDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.DebtorGroupDoc, mongopagination.PaginationData, error) {
...
func (pdt *DebtorGroupDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
