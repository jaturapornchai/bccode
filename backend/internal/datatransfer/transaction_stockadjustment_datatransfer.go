...
type IStockAdjustmentDataTransferRepository interface {
	FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.StockAdjustmentDoc, mongopagination.PaginationData, error)
}
...
func (repo StockAdjustmentDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.StockAdjustmentDoc, mongopagination.PaginationData, error) {
...
func (pdt *StockAdjustmentDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
