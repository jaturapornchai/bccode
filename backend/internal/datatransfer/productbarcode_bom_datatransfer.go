...
type IProductbarcodeBOMDataTransferRepository interface {
	FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.ProductBarcodeBOMViewDoc, mongopagination.PaginationData, error)
}
...
func (repo ProductbarcodeBOMDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.ProductBarcodeBOMViewDoc, mongopagination.PaginationData, error) {
...
func (pdt *ProductbarcodeBOMDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
