...
type IBookBankDataTransferDataTransferRepository interface {
	FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.BookBankDoc, mongopagination.PaginationData, error)
}
...
func (repo BookBankDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.BookBankDoc, mongopagination.PaginationData, error) {
...
func (dt *BookBankDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
