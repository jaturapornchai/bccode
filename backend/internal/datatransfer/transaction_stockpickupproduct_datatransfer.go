...
type IStockPickupProductDataTransferRepository interface {
	FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.StockPickupProductDoc, mongopagination.PaginationData, error)
}
...
func (repo StockPickupProductDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.StockPickupProductDoc, mongopagination.PaginationData, error) {
...
func (pdt *StockPickupProductDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
