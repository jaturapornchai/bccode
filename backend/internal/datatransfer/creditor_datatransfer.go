...
type ICreditorDataTransferRepository interface {
	FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.CreditorDoc, mongopagination.PaginationData, error)
}
...
func (repo CreditorDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.CreditorDoc, mongopagination.PaginationData, error) {
...
func (pdt *CreditorDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
