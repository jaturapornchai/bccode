...
type IBankMasterDataTransferRepository interface {
	FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.BankMasterDoc, mongopagination.PaginationData, error)
}
...
func (repo BankMasterDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.BankMasterDoc, mongopagination.PaginationData, error) {
...
func (dt *BankMasterDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
