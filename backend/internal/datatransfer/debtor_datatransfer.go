...
type IDebtorDataTransferRepository interface {
	FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.DebtorDoc, mongopagination.PaginationData, error)
}
...
func (repo DebtorDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.DebtorDoc, mongopagination.PaginationData, error) {
...
func (pdt *DebtorDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
