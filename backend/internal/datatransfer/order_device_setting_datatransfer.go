...
type IOrderDeviceSettingDataTransferRepository interface {
	FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.SettingDoc, mongopagination.PaginationData, error)
}
...
func (repo OrderDeviceSettingDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.SettingDoc, mongopagination.PaginationData, error) {
...
func (dt *OrderDeviceSettingDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
