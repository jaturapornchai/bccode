...
type IShopEmployeeDataTransferRepository interface {
	FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.EmployeeDoc, mongopagination.PaginationData, error)
}
...
func (repo ShopEmployeeDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.EmployeeDoc, mongopagination.PaginationData, error) {
...
func (pdt *ShopEmployeeDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
