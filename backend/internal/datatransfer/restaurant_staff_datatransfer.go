...
type IRestaurantStaffDataTransferRepository interface {
	FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.StaffDoc, mongopagination.PaginationData, error)
}
...
func (repo RestaurantStaffDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.StaffDoc, mongopagination.PaginationData, error) {
...
func (pdt *RestaurantStaffDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
