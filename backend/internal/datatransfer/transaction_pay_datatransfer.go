...
type ITransactionPayDataTransferRepository interface {
	FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.PayDoc, mongopagination.PaginationData, error)
}
...
func (repo TransactionPayDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.PayDoc, mongopagination.PaginationData, error) {
...
func (pdt *TransactionPayDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
