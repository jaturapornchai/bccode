...
type IStockReturnProductDataTransferRepository interface {
	FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.StockReturnProductDoc, mongopagination.PaginationData, error)
}
...
func (repo StockReturnProductDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.StockReturnProductDoc, mongopagination.PaginationData, error) {
...
func (pdt *StockReturnProductDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
