...
func (repo PosSettingDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.SettingDoc, mongopagination.PaginationData, error) {
...
func (pdt *PosSettingDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
