...
type IRestaurantZoneDataTransferRepository interface {
	FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.ZoneDoc, mongopagination.PaginationData, error)
}
...
func (repo RestaurantZoneDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.ZoneDoc, mongopagination.PaginationData, error) {
...
func (pdt *RestaurantZoneDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
