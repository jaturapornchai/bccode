...
type IPurchaseReturnDataTransferRepository interface {
	FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.PurchaseReturnDoc, mongopagination.PaginationData, error)
}
...
func (repo PurchaseReturnDataTransferRepository) FindPage(ctx context.Context, holdingCode string, searchInFields []string, pageable msModels.Pageable) ([]models.PurchaseReturnDoc, mongopagination.PaginationData, error) {
...
func (pdt *PurchaseReturnDataTransfer) StartTransfer(ctx context.Context, holdingCode string, targetHoldingCode string) error {
