...
func getDescriptionOverride(method, path string) (string, bool) {
	overrides := map[string]string{
		...
		"POST /create-holding":  "Create a new holding",
		"PUT /favorite-holding": "Set favorite holding for current user",

		// ===== Branch =====
		"GET /holding/branch":           "List all branches with search and pagination",
		"GET /holding/branch/list":      "Search branches with limit/offset pagination",
		"GET /holding/branch/{id}":      "Get branch detail by ID",
		"POST /holding/branch":          "Create new branch",
		"DELETE /holding/branch":        "Delete branch",
		...
		// ===== Employee =====
		"GET /holding/employee":         "List employees with search and pagination",
		"POST /holding/employee":        "Create new employee",
		"GET /holding/employee/{id}":    "Get employee detail by ID",
		"PUT /holding/employee/{id}":    "Update employee",
		"DELETE /holding/employee/{id}": "Delete employee",

		// ===== User/Permission =====
		"GET /holding/permission/{username}":    "Get holding user permission and profile by username",
		"PUT /holding/permission":               "Save holding user permission and profile (position, department, LINE, approval)",
		"DELETE /holding/permission/{username}": "Delete holding user permission",
