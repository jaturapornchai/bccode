...
type MongoDocModel struct {
	...
	CreatedAt        time.Time                `json:"created_at" bson:"createdat" mapstructure:"created_at"`         // วันเวลาที่สร้างเอกสาร
	...
	ModifiedAt       time.Time                `json:"modified_at" bson:"updatedat" mapstructure:"modified_at"`       // วันเวลาที่แก้ไข
	DocDateTime      time.Time                `json:"docdatetime" bson:"docdatetime"`
